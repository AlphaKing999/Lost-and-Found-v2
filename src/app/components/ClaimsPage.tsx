...
export function ClaimsPage() {
  ...
  const handleCheckStatus = () => {
    ...
    if (searchQuery.includes("@")) {
      ...
      if (results.length === 0) {
        ...
        setShowResults(true);
        toast.success(
          `Found ${results.length} claim${results.length !== 1 ? "s" : ""}`,
        );
      }
    } else {
      // Treat as claim ID
  ...
  // Get user's claims - display claims for the email entered in the form
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <h4
                          ...
                          style={{ color: getColor("textPrimary") }}
                        >
                          Found {searchResults.length} claim
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          {claim.adminNotes && (
                            <p
                              className="text-sm mb-2 italic p-2 rounded"
                              style={{
                          ...
                          >
                            ...
                            <span>
                              ...
                              by the email {claim.contactEmail}
                            </span>
                          </div>
                        </div>
                      </div>
